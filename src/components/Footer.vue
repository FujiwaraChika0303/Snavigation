<template>
  <footer id="footer" @click.stop>
    <div class="copyright">
      ...
      <span class="anthor" @click="jumpTo(copyrightLink ?? 'https://github.com/FujiwaraChika0303/Snavigation')">
        {{ siteAnthor }}
      </span>
      <span v-if="icp" class="icp" @click="jumpTo('https://info.yukinoshita.net')">
        {{ icp }}
      </span>
